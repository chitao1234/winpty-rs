...
3. Run `cargo check -p winptyrs-sys --features vendored --target x86_64-pc-windows-gnu`
4. Run `WINPTY_SOURCE_DIR="$HOME/ddev/winpty" cargo check -p winptyrs-sys --features vendored --target x86_64-pc-windows-gnu`
